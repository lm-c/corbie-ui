...
namespace LmCorbieUI {
  public partial class LmMsgBox : LmSingleForm {
    ...
    /// <summary>
    /// Posiciona o formulário na tela onde está o mouse
    /// </summary>
    private void PositionOnMouseScreen() {
      try {
        // Obtém a tela onde o mouse está posicionado
        Screen mouseScreen = ScreenHelper.GetScreenFromMouse();

        // Centraliza o formulário na tela do mouse
        ScreenHelper.CenterFormOnScreen(this, mouseScreen);

        // Alternativa: se preferir posicionar próximo ao mouse, descomente a linha abaixo
        // ScreenHelper.PositionFormNearMouse(this);
      } catch (Exception ex) {
        // Em caso de erro, usa posicionamento padrão
        this.StartPosition = FormStartPosition.CenterScreen;
        System.Diagnostics.Debug.WriteLine($"Erro ao posicionar formulário: {ex.Message}");
      }
    }
