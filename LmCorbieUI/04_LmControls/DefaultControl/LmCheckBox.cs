...
namespace LmCorbieUI.Controls {
  ...
  public partial class LmCheckBox : CheckBox, ILmControl {
    ...
    private void LmCheckBox_PreviewKeyDown(object sender, PreviewKeyDownEventArgs e) {
    ...
    private void InitializeComponent() {
      ...
      // LmCheckBox
      // 
      this.PreviewKeyDown += new System.Windows.Forms.PreviewKeyDownEventHandler(this.LmCheckBox_PreviewKeyDown);
